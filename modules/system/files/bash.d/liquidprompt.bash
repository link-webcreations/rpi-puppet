...
# If not running with compatible terminal, don't do anything
[[ $TERM != xterm* ]] && [[ $TERM != screen* ]] && return
...
_lp_source_config()
{
    ...
    local configfile
    if [[ -f "/etc/liquidprompt/liquidpromptrc" ]]
    then
        source "/etc/liquidprompt/liquidpromptrc"
    fi
